...
class AdminOptions {
	...
	function settings_init() : void {
		...
		register_setting( 'dagora-eshop-settings', 'wporg_options' );


		// Register a new section.
		add_settings_section(
			'dagora-eshop-settings-section',
			__( '', 'dagora-eshop-settings' ),
			[$this, 'render_section'],
			'dagora-eshop-settings'
		);
		...
		foreach( $this->fields as $field ) {
			...
			add_settings_field(
				...
				__( $field['label'], 'dagora-eshop-settings' ), /* Label for the field. */
				[$this, 'render_field'], /* The name of the callback function. */
				'dagora-eshop-settings', /* The menu page on which to display this field. */
				'dagora-eshop-settings-section', /* The section of the settings page in which to show the box. */
				[
	...
	function options_page() : void {
		add_menu_page(
			'Dagorà Reports eShop Settings', /* Page Title */
			'Dagorà eShop settings', /* Menu Title */
			$this->capability, /* Capability */
			'dagora-eshop-settings', /* Menu Slug */
	...
	function render_options_page() : void {
		...
		if ( isset( $_GET['settings-updated'] ) ) {
			...
			add_settings_error( 'wporg_messages', 'wporg_message', __( 'Settings Saved', 'dagora-eshop-settings' ), 'updated' );
		}
		...
		<div class="wrap">
			...
			<h2 class="description">Update and manage the core site settings here, particularly the API keys required for the site to function correctly.</h2>
			<form action="options.php" method="post">
				<?php
				/* output security fields for the registered setting "wporg" */
				settings_fields( 'dagora-eshop-settings' );
				/* output setting sections and their fields */
				/* (sections are registered for "wporg", each field is registered to a specific section) */
				do_settings_sections( 'dagora-eshop-settings' );
	...
	function render_field( array $args ) : void {
		...
		switch ( $field['type'] ) {
			...
			case "text": {
				...
				>
				<p class="description">
					<?php esc_html_e( $field['description'], 'dagora-eshop-settings' ); ?>
				</p>
				<?php
				break;
			}
	...
	function render_section( array $args ) : void {
		?>
		<p id="<?php echo esc_attr( $args['id'] ); ?>"><?php esc_html_e( 'API Keys', 'dagora-eshop-settings' ); ?></p>
		<?php
	}
